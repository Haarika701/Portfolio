    ...
    return (
        ...
        <div className="d-flex justify-content-center py-5 px-5" >
            ...
            <div className="card" style={{ width: 40 + 'rem' }}>
                <Image src="/static/portfolio2.jpeg" className="card-img-top" alt="profile"></Image>
            </div>
            ...
            <Link href="https://github.com/Haarika701" class="link-dark link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="40" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
